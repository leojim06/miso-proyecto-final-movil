                    ...
                    <View style={infoPanelStyles({ height: modalHeight }).infoIconContainer}>
                        {
                            props.type === 'success' || props.type === 'info'
                                ? <Image source={require('../../assets/icons/aprobado.png')} style={infoPanelStyles().image} />
                                : props.type === 'warn'
                                    ? <Image source={require('../../assets/icons/pendiente.png')} style={infoPanelStyles().image} />
                                    : <Image source={require('../../assets/icons/denegado.png')} style={infoPanelStyles().image} />
                        }
                    </View>
                    <View style={infoPanelStyles().content}>
                        <View style={{
                        ...
                        }}>
                            {
                                props.tempInfo
                                    ? (<Text
                                        style={{ color: '#ABABAB', fontSize: 18,  }}>
                                        {props.tempInfo}
                                    </Text>)
                                    : (null)
                            }
                        ...
                        <View style={infoPanelStyles().titleContent}>
                            <Text allowFontScaling={false} style={[infoPanelStyles(props).title]} >{props.title}</Text>
                        </View>
                        <View style={infoPanelStyles().messageContent}>
                            <Text allowFontScaling={false}
                                style={[
                                    ...
                                    props.type === 'info' ? { textAlign: 'left' } : { textAlign: 'center' }
                                ]}>
                                {props.message}
                            </Text>
                        </View>
                        ...
                        <View style={infoPanelStyles().buttonContent}>
                            {
                                props.type === 'error' || props.type === 'success' || props.type === 'info'
                                    ?
                                    (
                                        < MainButton onPress={props.onAcceptPress} title={props.acceptButtonTitle || ''} />
                                    )
                                    :
                                    (
                                        <View style={infoPanelStyles().contentBtn}>
                                            <View style={{ flex: 1 }}>
                                                <MainButtonIcon title={props.cancelButtonTitle || ''} onPress={props.onCancelPress} backgroundColor={'#D91A32'} />
                                            </View>
                                            <View style={{ width: 15 }} />
                                            <View style={{ flex: 1 }}>
                                                <MainButtonIcon title={props.confirmButtonTitle || ''} onPress={props.onConfirPress} backgroundColor={'#2E7480'} />
                                            </View>
                                        </View>
                                    )
                            }
...
function infoPanelStyles(props?) {
    return StyleSheet.create({
        ...
        title: {
            textAlign: 'center',
            color: props?.type === 'success' ? '#60B200' :
                props?.type === 'warn' ? '#F9A31A' :
                    props?.type === 'info' ? '#F58525' : '#D91A32',
        },
        messageContent: {
            justifyContent: 'center',
            alignItems: 'center'
